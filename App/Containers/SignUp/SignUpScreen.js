...
const AlertIcon = (props) => <Icon {...props} name="alert-circle-outline" fill="#FFFFFF" />
    ...
    <SafeAreaView style={Helpers.fullSize}>
      <Layout style={Style.layout}>
        ...
        {userIsLoading ? (
          ...
          <>
            <Header title="Cadastrar" appearance="control" />
            <Layout style={Style.container}>
              ...
              <View>
                <KeyboardAvoidingView>
                  <Input style={Style.input} placeholder="Nome" size="large" />
                  <Input style={Style.input} placeholder="E-Mail" size="large" />
                  <Input style={Style.input} placeholder="Celular" size="large" />
                  <Input
                    style={[Style.input, Metrics.mediumBottomMargin]}
                    value={password}
                    placeholder="Senha"
                    caption={
                      <Text style={{ ...Fonts.small, color: 'white' }}>
                    ...
                    size="large"
                  />
                  <Button style={Style.button} status="basic">
                    CADASTRAR
                  </Button>
                </KeyboardAvoidingView>
                <Button
